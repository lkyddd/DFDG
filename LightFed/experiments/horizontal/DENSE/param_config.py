...
def get_args():
    ...
    parser.add_argument('--I_c', type=int, default=100, help='iteration of the training procedure in each client')
    ...
    parser.add_argument("--beta_bn", type=float, default=1.0, help="hyper-parameter of L_BN loss") ##
    
    parser.add_argument("--beta_div", type=float, default=1.0, help="hyper-parameter of L_div loss")

    parser.add_argument('--noise_label_combine', type=str, default='none', choices=['mul', 'add', 'cat', 'cat_naive', 'none'])
