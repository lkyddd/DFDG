...
def get_args():
    ...
    parser.add_argument('--model_heterogeneity', type=lambda s: s == 'True', default=False)

    parser.add_argument('--model_here_level', type=int, default=2, choices=[2, 3, 4])
    ...
    parser.add_argument('--mask_ensemble_gen', type=lambda s: s == 'True', default=False)

    parser.add_argument('--mask_ensemble_glo', type=lambda s: s == 'True', default=False)

    ###
    parser.add_argument("--I", type=int, default=1, help="iteration of the training procedure in server")

    parser.add_argument("--I_g", type=int, default=20, help="inner iterations of training the each generator")
    ...
    parser.add_argument("--beta_cd", type=float, default=1.0, help="hyper-parameter for corss-divergence loss")

    parser.add_argument("--beta_ey", type=float, default=0.0, help="hyper-parameter for ey loss")

    parser.add_argument("--gamma", type=float, default=1.0, help="hyper-parameter for Embedding")

    parser.add_argument('--condition_', type=lambda s: s == 'True', default=True)

    parser.add_argument('--dual_noise', type=lambda s: s == 'True', default=False)
    ...
    parser.add_argument("--I_d", type=int, default=2, help="inner iterations of training the global model")
    ...
    parser.add_argument('--app_name', type=str, default='DFDG')
...
def _get_model_split_rate(args):
    if args.model_heterogeneity == False:
        ...
        # sample_rate = torch.tensor(reta_list)
    return reta_list
